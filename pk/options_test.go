...
func TestWithForceRun(t *testing.T) {
	...
	task := NewTask(TaskConfig{Name: "path-task", Usage: "test task", Body: Do(func(_ context.Context) error {
		runCount.Add(1)
		return nil
	})})
...
func TestPathFilter_MultiplePaths(t *testing.T) {
	...
	task := NewTask(TaskConfig{Name: "multi-path-task", Usage: "test task", Body: Do(func(ctx context.Context) error {
...
func TestPathFilter_MultiplePathsWithDedup(t *testing.T) {
	...
	task := NewTask(TaskConfig{Name: "multi-path-dedup-task", Usage: "test task", Body: Do(func(_ context.Context) error {
		runCount.Add(1)
		return nil
	})})
...
func TestPathFilter_DeduplicationByTaskAndPath(t *testing.T) {
	...
	task := NewTask(TaskConfig{Name: "path-dedup-task", Usage: "test task", Body: Do(func(_ context.Context) error {
		runCount.Add(1)
		return nil
	})})
