...
func TestWithForceRun(t *testing.T) {
	...
	task := &Task{Name: "path-task", Usage: "test task", Do: func(_ context.Context) error {
		runCount.Add(1)
		return nil
	}}
...
func TestPathFilter_MultiplePathsWithDedup(t *testing.T) {
	...
	task := &Task{Name: "multi-path-dedup-task", Usage: "test task", Do: func(_ context.Context) error {
		runCount.Add(1)
		return nil
	}}
...
func TestPathFilter_DeduplicationByTaskAndPath(t *testing.T) {
	...
	task := &Task{Name: "path-dedup-task", Usage: "test task", Do: func(_ context.Context) error {
		runCount.Add(1)
		return nil
	}}
